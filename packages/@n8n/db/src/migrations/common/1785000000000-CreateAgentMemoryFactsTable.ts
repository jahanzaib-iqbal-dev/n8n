...
/**
 * Stores cross-thread fact memory scoped by (agentId, resourceId).
 *
 * resourceId maps to the user id for this feature. Embeddings are stored as
 * JSON so the first spike can rank in application code without requiring a
 * vector extension or sidecar database.
 */
